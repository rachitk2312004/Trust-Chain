/**
 * Wave 10 ops unit checks — compiled dist imports (CI fallback).
 * Run: npx tsc -p services/tsconfig.json && node services/ops-unit-check-dist.mjs
 */
...
} from "./dist/analytics/src/index.js";
import { buildHealthSnapshot, log, startSpan, endSpan } from "./dist/monitoring/src/index.js";
import {
  createPolicyDraft,
  canActivatePolicy,
  resolveApproval,
...
import { buildReportSummary } from "./dist/reporting/src/index.js";
import {
  gdprChecklist,
  soc2Checklist,
  iso27001Checklist,
  markItemComplete,
} from "./dist/compliance/src/index.js";
import { evaluateRule, maxSeverity } from "./dist/alerting/src/index.js";
import {
  createRelease,
  listEnvironments,
  createRollbackPlan,
...
} from "./dist/deployment/src/index.js";
import {
  recordBackup,
  createSnapshot,
  buildRestorationPlan,
  validateRecovery,
} from "./dist/recovery/src/index.js";
import {
  computeStorageUsage,
  computeUsage,
  networkUsage,
  forecastLinear,
} from "./dist/capacity/src/index.js";
import {
  classifyResource,
  appendLineageStep,
  defineDataRetention,
...
import {
  ...
  checkServiceHealth,
  clearRegistry,
} from "./dist/discovery/src/index.js";
import {
  scheduleRotation,
  validateSecretRef,
  describeSecretRef,
  checkSecretAccess,
  clearSecretAudit,
} from "./dist/secrets/src/index.js";
import {
  publishEvent,
  consumeEvents,
  replayEvents,
  clearEventBus,
} from "./dist/events/src/index.js";
